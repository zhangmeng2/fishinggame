...
export const CAST_SPEED = 50;
export const HOOK_RADIUS = 1.5;
...
export const FISH_TYPES = [
  { name: '鲫鱼', color: '#c0c0c0', score: 10, speed: 3, size: 8, spawnWeight: 10 },
  { name: '鲤鱼', color: '#e8a020', score: 30, speed: 5, size: 12, spawnWeight: 5 },
  { name: '草鱼', color: '#4a8c3f', score: 50, speed: 7, size: 14, spawnWeight: 2 },
];
